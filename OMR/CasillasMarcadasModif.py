...
def Extraer_Numero_Matricula(ruta_pdf):
    ...
    coordenadas_roi = Dimensiones_ROI(x = 387, y = 135, ancho = 110, alto = 170)

    recorte = Extraer_ROI_Iamgen(imagen, coordenadas_roi)

    _, _, recorteProcesado = Leer_DNI_OMR(recorte)

    numero_matricula = Detectar_Resultado_OMR(recorteProcesado)
